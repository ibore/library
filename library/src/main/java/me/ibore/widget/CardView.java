...
/**
 * https://github.com/linwg1988/LCardView/
 */
public class CardView extends ConstraintLayout {
    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            if (index == R.styleable.CardView_cvShadowSize) {
                shadowSize = typedArray.getDimensionPixelSize(index, -1);
            } else if (index == R.styleable.CardView_cvShadowColor) {
                shadowColor = typedArray.getColor(index, defaultShadowColor);
            } else if (index == R.styleable.CardView_cvShadowStartAlpha) {
                shadowAlpha = typedArray.getInt(index, defaultShadowStartAlpha);
            } else if (index == R.styleable.CardView_cvShadowFluidShape) {
                shadowFluidShape = typedArray.getInt(index, ADSORPTION);
            } else if (index == R.styleable.CardView_cvBackgroundColor) {
                cardBackgroundColor = typedArray.getColor(index, Color.WHITE);
            } else if (index == R.styleable.CardView_cvCornerRadius) {
                cornerRadius = typedArray.getDimensionPixelSize(index, 0);
            } else if (index == R.styleable.CardView_cvLeftTopCornerRadius) {
                leftTopCornerRadius = typedArray.getDimensionPixelSize(index, 0);
            } else if (index == R.styleable.CardView_cvLeftBottomCornerRadius) {
                leftBottomCornerRadius = typedArray.getDimensionPixelSize(index, 0);
            } else if (index == R.styleable.CardView_cvRightTopCornerRadius) {
                rightTopCornerRadius = typedArray.getDimensionPixelSize(index, 0);
            } else if (index == R.styleable.CardView_cvRightBottomCornerRadius) {
                rightBottomCornerRadius = typedArray.getDimensionPixelSize(index, 0);
            } else if (index == R.styleable.CardView_cvElevation) {
                elevation = typedArray.getDimensionPixelSize(index, 0);
            } else if (index == R.styleable.CardView_cvElevationAffectShadowColor) {
                elevationAffectShadowColor = typedArray.getBoolean(index, false);
            } else if (index == R.styleable.CardView_cvElevationAffectShadowSize) {
                elevationAffectShadowSize = typedArray.getBoolean(index, false);
            } else if (index == R.styleable.CardView_cvLeftOffset) {
                leftOffset = typedArray.getDimensionPixelSize(index, 0);
            } else if (index == R.styleable.CardView_cvRightOffset) {
                rightOffset = typedArray.getDimensionPixelSize(index, 0);
            } else if (index == R.styleable.CardView_cvTopOffset) {
                topOffset = typedArray.getDimensionPixelSize(index, 0);
            } else if (index == R.styleable.CardView_cvBottomOffset) {
                bottomOffset = typedArray.getDimensionPixelSize(index, 0);
            } else if (index == R.styleable.CardView_cvFixedContentWidth) {
                fixedContentWidth = typedArray.getBoolean(index, false);
            } else if (index == R.styleable.CardView_cvFixedContentHeight) {
