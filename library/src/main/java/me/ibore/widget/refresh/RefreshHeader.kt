...
interface RefreshHeader {
     ...
     *  当内容视图到达顶部，视图将被重置
     */
    fun onReset(refreshLayout: RefreshLayout)

    /**
     * 准备下拉，作初始化工作
     */
    fun onPrepare(refreshLayout: RefreshLayout)
     ...
     */
    fun onComplete(refreshLayout: RefreshLayout, isSuccess:Boolean)
     ...
     */
    fun onScroll(refreshLayout: RefreshLayout, distance: Int, percent: Float, refreshing: Boolean)
