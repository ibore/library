...
class CacheDiskUtils private constructor(
        ...
        get() {
            if (cacheDir.exists()) {
                ...
                if (cacheDir.mkdirs()) {
                    ...
                    Log.e("CacheDiskUtils", "can't make dirs in " + cacheDir.absolutePath)
                }
            }
    ...
    fun put(key: String, value: Bitmap?, saveTime: Int = -1) {
        realPutBytes(TYPE_BITMAP + key, if (value == null) null else UtilsBridge.bitmap2Bytes(value), saveTime)
    }
    ...
    fun put(key: String, value: Drawable?, saveTime: Int = -1) {
        realPutBytes(TYPE_DRAWABLE + key, if (value == null) null else UtilsBridge.drawable2Bytes(value), saveTime)
    }
    ...
    companion object {
        ...
        fun getInstance(
            ...
            if (UtilsBridge.isSpace(cacheNameTemp)) cacheNameTemp = "cacheUtils"
