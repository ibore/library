...
object QRCodeDecoder {
    val ALL_HINT_MAP: MutableMap<DecodeHintType, Any?> = EnumMap(DecodeHintType::class.java)
    val ONE_DIMENSION_HINT_MAP: MutableMap<DecodeHintType, Any> = EnumMap(DecodeHintType::class.java)
    val TWO_DIMENSION_HINT_MAP: MutableMap<DecodeHintType, Any> = EnumMap(DecodeHintType::class.java)
    val QR_CODE_HINT_MAP: MutableMap<DecodeHintType, Any> = EnumMap(DecodeHintType::class.java)
    val CODE_128_HINT_MAP: MutableMap<DecodeHintType, Any> = EnumMap(DecodeHintType::class.java)
    val EAN_13_HINT_MAP: MutableMap<DecodeHintType, Any> = EnumMap(DecodeHintType::class.java)
    val HIGH_FREQUENCY_HINT_MAP: MutableMap<DecodeHintType, Any> = EnumMap(DecodeHintType::class.java)
    ...
    fun syncDecodeQRCode(picturePath: String): String {
        return syncDecodeQRCode(BGAQRCodeUtil.getDecodeAbleBitmap(picturePath) ?: return "")
    }
