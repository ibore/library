...
import me.ibore.qrcode.BGAQRCodeUtil.getScreenResolution
...
internal class CameraConfigurationManager(private val mContext: Context) {
    ...
    fun initFromCameraParameters(camera: Camera) {
        val screenResolution = getScreenResolution(mContext)
        ...
        cameraResolution = if (BGAQRCodeUtil.isPortrait(mContext)) {
